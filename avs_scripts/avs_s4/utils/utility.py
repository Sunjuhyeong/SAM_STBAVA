...
def mask_iou(pred, target, eps=1e-7, size_average=True, normalized=False, reverse_prediction=False):
    r"""
        param: 
            pred: size [N x H x W]
...
def save_mask(pred_masks, save_base_path, category_list, video_name_list, normalized=False, reverse_prediction=False):
